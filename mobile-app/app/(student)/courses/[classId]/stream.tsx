...
export default function StudentClassStreamScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.subHeader}>
        ...
        <TouchableOpacity style={styles.subHeaderTab} onPress={() => navigateToSubSection('materials')}>
          <Text style={styles.subHeaderTabTxt}>Materials</Text>
        </TouchableOpacity>
      </View>
        ...
        <FlatList
          ...
          ListHeaderComponent={
            <View style={styles.composerCard}>
              <Text style={styles.composerTitle}>Ask a question or share a thought</Text>
              <TextInput
